...
print("Points Earned:",points_earned, "-> type:", type(point_earned))
...
event_couut_text = str(event_court)
...
print("Point as text:", point_text, "-> type:", type(point_text))
...
reseverd_club = club[::-1]
print("Reserved Club Name:", reserved_club)
